            ...
            <div className="wrap">
                ...
                <div>
                    ...
                    <input type="text" 
                        ...
                        onChange={this.handelChange.bind(this,"inputValue")}
                    />
                    <select value={this.state.selectValue}
                            onChange={this.handelChange.bind(this,"selectValue")}
                    >
                ...
                <div>
                    <button onClick={this.change_value.bind(this)}>改变表单元素值</button>
                </div>
            </div>
        )
    }
